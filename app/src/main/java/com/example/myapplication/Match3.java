...
public class Match3 extends AppCompatActivity {
    ...
    static String match3gender="",match3si="",match3age="";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        spin1.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                match3si = spin1.getSelectedItem().toString();
        ...
        rdggender.setOnCheckedChangeListener( new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup group, int i) {
                if(i == R.id.rdbm){
                    match3gender = rdbm.getText().toString();
                }
                else if(i == R.id.rdbw){
                    match3gender = rdbw.getText().toString();
                }
                else if(i == R.id.rdbgno){
                    match3gender = rdbgno.getText().toString();
                }
            }
        } );//////////////////////////////////////////////////////////////////////////////////////////////radiogroup gender
        ...
        btnresult.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Match3.this, Matchmenu.class);
