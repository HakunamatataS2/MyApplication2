...
public class Interestpost extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_interestpost);
        ...
        ///////////////////////////////////////////////////////////////////////////////////////////////////////////////글 가져오기
        try{
            URL url = new URL(SERVER_ADDRESS + "/interest_list.php?"
                    + "id=" + URLEncoder.encode(loginid,"UTF-8")
            );
            url.openStream();
            getXmlData2("interest_list.xml");
        } catch(Exception e) {

            Toast.makeText(Interestpost.this, "인터넷 연결을 확인하세요.", Toast.LENGTH_SHORT).show();
        ...
        //////////////////////////////////////////////////////////////////////total1 가져오기
        try {
            URL url = new URL(SERVER_ADDRESS + "/interest_total_list.php?"
                    + "id=" + URLEncoder.encode(loginid,"UTF-8")
            );
            url.openStream();
            getXmlData3("interest_total_list.xml");
        } catch (Exception e) {
            Toast.makeText(Interestpost.this, "인터넷 연결을 확인하세요.", Toast.LENGTH_SHORT).show();
            Log.e("Error", e.getMessage());
        }
        ...
        simpleList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(Interestpost.this , Writeframe.class);
                int to = position*15;
