...
public class Match2 extends AppCompatActivity {
    ...
    static String match2gender="",match2si="",match2age="";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        spin1.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                match2si = spin1.getSelectedItem().toString();
        ...
        rdggender.setOnCheckedChangeListener( new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup group, int i) {
                if(i == R.id.rdbm){
                    match2gender = rdbm.getText().toString();
                }
                else if(i == R.id.rdbw){
                    match2gender = rdbw.getText().toString();
                }
                else if(i == R.id.rdbgno){
                    match2gender = rdbgno.getText().toString();
                }
            }
        } );//////////////////////////////////////////////////////////////////////////////////////////////radiogroup gender
        ...
        btnresult.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Match2.this, Matchmenu.class);
